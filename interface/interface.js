...
function displayInfos() {
  interfaceVariables.scoreTag.innerText =
    "Score" + " : " + interfaceVariables.score;
  interfaceVariables.lifeTag.innerText =
    "Life" + " : " + interfaceVariables.life;
  interfaceVariables.timerTag.innerText =
    "Time" + " : " + interfaceVariables.time;
  ...
  interfaceVariables.bombsTag.innerText =
    "Bombs" + " : " + interfaceVariables.bombs;
}
displayInfos();
...
function timer() {
  ...
  interfaceVariables.time =
    interfaceVariables.time <= 0 ? 0 : interfaceVariables.time - 1;
}
