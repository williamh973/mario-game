...
function createSpriteDrown(imageSrc) {
...
class Bounty21 {
    constructor() {
        this.position = {  // position de l'objet dans le canvas par rapport au axes x et y
            x: 14300,  // position de la 1ere plateforme sur l'axe X
            y: 485, 
        }
        this.width = 40   // longueur en px du carré
        this.height = 40  // hauteur en px du carré
...
class Brick {
    constructor() {
        ...
        this.sprites = {
            ...
            break: {
                right: createBrickBreak(brickBreak),
                cropWidth: 150,
                width: 150,
            },
            }
...
function createWater01(imageSrc) {
    const water01 = new Image()
    water01.src = "./images/water01.png"
    return water01
}

function createWater02(imageSrc) {
...
// particule sur le joueur lors d'une collision avec un champiB ou champiR
...
// particule sur le joueur lors d'une collision avec une Brick
...
// particule sur le joueur lors d'une collision avec une pièce d'or
...
rocks.forEach((thebigRock) => {
 ...
 tonneaux.forEach((theTonneau) => {
    ...
    if (scrollOffset > 14637) {
       alert("Bravo, vous avez gagné ! Votre score est de " + stock, " points.")
       init()
       vie = 1;
...
//  si le chronomètre arrive a zéro, le jeu est perdu et se réinitialise.
if(time === 0) {
    alert("Temps écoulé, vous avez perdu ! Cliquez sur \"OK\" pour recommencer.")
    init()
    vie = 1;
    lifeTag.innerText = "Vie : " + vie;
    stock = 0;
...
// le timer
timerTag.style.fontFamily = "impact";
timerTag.style.fontStyle = "italic"
timerTag.style.fontSize = "30px";
timerTag.style.color = "white";
timerTag.innerText = time;
timerTag.style.position = "absolute";
timerTag.style.top = "50px";
timerTag.style.right = "750px";
