...
class Bounty7 {
    constructor() {
        this.position = {  // position de l'objet dans le canvas par rapport au axes x et y
            x: 5431,  // position de la 1ere plateforme sur l'axe X
            y: 452,
        }
        this.width = 40   // longueur en px du carré
        this.height = 40  // hauteur en px du carré
...
class Bounty13 {
    constructor() {
        this.position = {  // position de l'objet dans le canvas par rapport au axes x et y
            x: 8082,  // position de la 1ere plateforme sur l'axe X
            y: 255,
        }
        this.width = 40   // longueur en px du carré
        this.height = 40  // hauteur en px du carré
...
function createPlatformBrickSmall(imageSrc) {
    const platformBrickS = new Image()
    platformBrickS.src = "./images/platform-brick-small.png"
    return platformBrickS
}
...
let thePlatformBricksmall = createPlatformBrickSmall("./images/platform-brick-small.png")
...
function init() {
    ...
    thePlatformBricksmall = createPlatformBrickSmall("./images/platform-brick-small.png");
