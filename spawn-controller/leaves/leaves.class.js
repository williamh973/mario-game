...
export let theLeaves = createLeaves01(
  "../../assets/images/green-leavesSmall.png",
);
export let theLeavesRight = createLeaves02(
  "../../assets/images/green-leavesSmallRight.png",
);
