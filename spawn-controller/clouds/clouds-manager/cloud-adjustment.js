// import { bigCloudList, littleCloudList } from "./clouds-dispach";



// export function adjustGrassPlatform494x72Positions() {
//     return new Promise((resolve) => {
//         for (let i = 0; i < littleCloudList.length; i++) {
//             for (let j = 0; j < bigCloudList.length; j++) {
//                 if (littleCloudList[i].overlapsWith(platformList494x72[j])) {
