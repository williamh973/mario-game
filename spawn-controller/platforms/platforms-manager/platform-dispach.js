...
import { thePlatform494x72, theplateform84x72, theplateform202x56, thePlatform150x72, theplateform500x43, theplateform630x217, theplateform158x78, theplateformGreenSmall } from "./platform-assets.js";
    ...
    export function dispachGrassPlatforms500x43() {
        return new Promise((resolve) => {
            ...
            for (let i = 0; i < 6; i++) {
                ...
                let randomFactor = Math.random();
                let randomNumberBetweenX = Math.floor(randomFactor * (150)) + 8700 + i * 660;
