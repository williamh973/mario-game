...
function ChampiBSpriteSRight(imageSrc) {
    const champibSprite = new Image()
    champibSprite.src = "./images/champiBSpriteStand.png"
      return champibSprite
      }

      let champiBStand = ChampiBSpriteSRight("./images/champiBSpriteStand.png")
...
//             y: 0
//         }
//         this.width = 45   // longueur en px du carré
//         this.height = 45  // hauteur en px du carré
    
    
    
//         // On applique les sprites créés en amont pour remplacer le carré
//         this.image = ChampiBSpriteSRight(champiBStand)
//         this.frames = 0
//         this.sprites = {
//             stand: {
//                 right: ChampiBSpriteSRight(champiBStand),
//                 cropWidth: 40,
//                 width: 45
//             },
//         }
